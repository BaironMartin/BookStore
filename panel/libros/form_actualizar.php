                ...
                <fieldset>
                    ...
                    <form action="../acciones.php" method="POST" enctype="multipart/form-data" class="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="formGroupExampleInput" name="titulo" value="<?php print $resultado['titulo']; ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">Descripcion</label>
                            <textarea class="formu-input ckeditor" id="ckeditor" name="descripcion" rows="3" required><?php print $resultado['descripcion']; ?></textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="categoriaid" class="form-control" id="exampleFormControlSelect1" required>
                                ...
                                ?>
                                    ...
                                    <?php print $resultado['categoriaid'] == $item['id'] ?'selected':''?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="formGroupExampleInput" name="precio" value="<?php print $resultado['precio']; ?>">
                        </div>
                        <div class="container center-align">
                            <input type="submit" name="action" class="btn btn-success " value="Modificar" />
